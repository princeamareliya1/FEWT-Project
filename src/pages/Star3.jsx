          ...
          <div className="row align-items-center g-4">
            ...
            <div className="col-lg-9 text-center text-lg-start">
              <div className="d-flex flex-wrap justify-content-center justify-content-lg-start gap-2 mb-3">
                ...
                <span className="cyber-badge">METHOD ACTOR</span>
              </div>
              
              <h1 className="display-4 fw-bold text-white mb-2">Christian Bale</h1>
              
              <p className="fs-5 text-secondary fw-light mb-4" style={{ maxWidth: '750px', lineHeight: 1.7 }}>
                Christian Bale is an English actor world-renowned for his extreme physical transformations and intense psychological portrayals in Christopher Nolan's The Dark Knight trilogy, American Psycho, and The Fighter.
              </p>
              ...
              <div className="row g-3">
                <div className="col-6 col-md-3">
                  <div className="p-3 rounded-3" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border-color)' }}>
                    ...
                    <strong className="text-white">January 30, 1974</strong>
                  </div>
                </div>
                <div className="col-6 col-md-3">
                  <div className="p-3 rounded-3" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border-color)' }}>
                    <span className="d-block small text-muted">Birthplace</span>
                    <strong className="text-white">Haverfordwest, UK</strong>
                  </div>
                </div>
                <div className="col-6 col-md-3">
                  <div className="p-3 rounded-3" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border-color)' }}>
                    <span className="d-block small text-muted">Box Office</span>
                    <strong style={{ color: 'var(--secondary-neon)' }}>$5.4 Billion</strong>
                  </div>
                </div>
                <div className="col-6 col-md-3">
                  <div className="p-3 rounded-3" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border-color)' }}>
                    <span className="d-block small text-muted">Known Works</span>
                    <strong className="text-white">50+ Titles</strong>
                  </div>
                </div>
              </div>
              ...
              <div className="row row-cols-1 row-cols-md-2 g-3">
                <div className="col">
                  <div className="movie-card h-100 p-3 d-flex gap-3 align-items-center">
                    <img 
                      src="https://m.media-amazon.com/images/M/MV5BNzVjYThjNjItYjcwOC00N2I2LWE2OTgtMDNmYzc4MDUxZmFmXkEyXkFqcGdeQXVyMDM2NDM2MQ@@._V1_.jpg" 
                      alt="The Bride!" 
                      style={{ width: '80px', height: '110px', objectFit: 'cover', borderRadius: '8px' }}
                    />
                    <div>
                      <span className="cyber-badge mb-2">OCT 2026</span>
                      <h6 className="fw-bold text-white mb-1">The Bride!</h6>
                      <small className="text-muted d-block">Role: Frankenstein's Monster</small>
                    </div>
                  </div>
                </div>
                ...
                <div className="col">
                  <div className="movie-card h-100 p-3 d-flex gap-3 align-items-center">
                    <img 
                      src="https://m.media-amazon.com/images/M/MV5BMTI5NDY5NjU3NF5BMl5BanBnXkFtZTcwMzQ0MTc5Mw@@._V1_.jpg" 
                      alt="The Church of Living Dangerously" 
                      style={{ width: '80px', height: '110px', objectFit: 'cover', borderRadius: '8px' }}
                    />
                    <div>
                      <span className="cyber-badge mb-2">IN PRODUCTION</span>
                      <h6 className="fw-bold text-white mb-1">Living Dangerously</h6>
                      <small className="text-muted d-block">Role: John Lee Hooker</small>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="row row-cols-2 row-cols-md-3 g-3">
                ...
                <div className="col">
                  <div className="movie-card h-100">
                    ...
                    <div className="p-3">
                      <h6 className="fw-bold text-white mb-1 text-truncate">The Dark Knight</h6>
                      <p className="small text-muted mb-0">Role: Bruce Wayne / Batman</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col">
                  <div className="movie-card h-100">
                    <div className="card-img-wrapper">
                      <img src="https://m.media-amazon.com/images/M/MV5BZTM3HDRjA2UtOWZmNi00N2ZhLTlhNWItYWExM2VhZTBhNWFiXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg" alt="American Psycho" />
                    </div>
                    <div className="p-3">
                      <h6 className="fw-bold text-white mb-1 text-truncate">American Psycho</h6>
                      <p className="small text-muted mb-0">Role: Patrick Bateman</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col">
                  <div className="movie-card h-100">
                    <div className="card-img-wrapper">
                      <img src="https://m.media-amazon.com/images/M/MV5BMjA4NDI0MTIxNF5BMl5BanBnXkFtZTcwNTM0MzUyMQ@@._V1_.jpg" alt="The Prestige" />
                    </div>
                    <div className="p-3">
                      <h6 className="fw-bold text-white mb-1 text-truncate">The Prestige</h6>
                      <p className="small text-muted mb-0">Role: Alfred Borden</p>
                    </div>
                  </div>
                </div>
