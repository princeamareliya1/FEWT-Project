          ...
          {watchlist.length > 0 ? (
                ...
                <div className="col" key={item.id}>
                  <div className="card movie-card text-white h-100">
                    ...
                    <div className="card-body p-3 p-md-4">
                      <h5 className="card-title text-truncate fw-bold m-0" style={{ fontSize: '1.1rem' }}>
                        {item.title}
                      </h5>
                      <p className="card-text small mt-2 mb-0" style={{ color: 'var(--text-muted)' }}>
                        {item.genre}
                      </p>
                      <button
                        type="button"
                        className="btn btn-outline-cyber mt-3 w-100"
            ...
            <div className="text-center py-5 my-5">
              ...
              <p className="mb-4" style={{ color: 'var(--text-muted)' }}>
                Explore the collection grids to construct your cinematic schedule.
              </p>
              <Link to="/" className="btn btn-premium px-4 py-2">
