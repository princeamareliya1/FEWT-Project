export default function Profile() {
  return (
    <div>
      <div className="container-fluid px-md-5 px-4 py-5">
        <div className="cyber-card mb-4 p-4">
          <div className="d-flex flex-column flex-xl-row align-items-start gap-4">
            ...
            <div className="flex-fill">
              ...
              <div className="d-flex align-items-center flex-wrap gap-3 gap-md-4">
                <div>
                  <div className="fs-4 fw-bold text-white">85</div>
            ...
            <div className="d-flex gap-2 mt-3 mt-xl-0">
              <button type="button" className="btn btn-premium" disabled><i className="bi bi-pencil me-1"></i> Edit Profile</button>
        ...
        <div className="row g-4">
          <div className="col-lg-4">
            <div className="cyber-card h-100 p-4">
              <div className="mb-4">
              ...
              <div className="mt-4 pt-4 border-top" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
