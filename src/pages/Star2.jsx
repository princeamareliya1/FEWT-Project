          ...
          <div className="row align-items-center g-4">
            ...
            <div className="col-lg-9 text-center text-lg-start">
              <div className="d-flex flex-wrap justify-content-center justify-content-lg-start gap-2 mb-3">
                ...
                <span className="cyber-badge">CINEMATIC ICON</span>
              </div>
              
              <h1 className="display-4 fw-bold text-white mb-2">Leonardo DiCaprio</h1>
              
              <p className="fs-5 text-secondary fw-light mb-4" style={{ maxWidth: '750px', lineHeight: 1.7 }}>
                Leonardo DiCaprio is an acclaimed American actor and producer recognized for his transformative roles in biopics, period dramas, and high-concept sci-fi thrillers like Inception, Titanic, and The Revenant.
              </p>
              ...
              <div className="row g-3">
                <div className="col-6 col-md-3">
                  <div className="p-3 rounded-3" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border-color)' }}>
                    ...
                    <strong className="text-white">November 11, 1974</strong>
                  </div>
                </div>
                <div className="col-6 col-md-3">
                  <div className="p-3 rounded-3" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border-color)' }}>
                    <span className="d-block small text-muted">Birthplace</span>
                    <strong className="text-white">Los Angeles, USA</strong>
                  </div>
                </div>
                <div className="col-6 col-md-3">
                  <div className="p-3 rounded-3" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border-color)' }}>
                    <span className="d-block small text-muted">Box Office</span>
                    <strong style={{ color: 'var(--secondary-neon)' }}>$7.2 Billion</strong>
                  </div>
                </div>
                <div className="col-6 col-md-3">
                  <div className="p-3 rounded-3" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border-color)' }}>
                    <span className="d-block small text-muted">Known Works</span>
                    <strong className="text-white">45+ Titles</strong>
                  </div>
                </div>
              </div>
              ...
              <div className="row row-cols-1 row-cols-md-2 g-3">
                <div className="col">
                  <div className="movie-card h-100 p-3 d-flex gap-3 align-items-center">
                    ...
                    />
                    <div>
                      <span className="cyber-badge mb-2">LATE 2026</span>
                      <h6 className="fw-bold text-white mb-1">The Wager</h6>
                      <small className="text-muted d-block">Role: Captain David Cheap</small>
                    </div>
                  </div>
                </div>
                ...
                <div className="col">
                  <div className="movie-card h-100 p-3 d-flex gap-3 align-items-center">
                    <img 
                      src="https://m.media-amazon.com/images/M/MV5BMTM0ODU5Nzk2OV5BMl5BanBnXkFtZTcwMzI2NzQ2NzM@._V1_.jpg" 
                      alt="Roosevelt" 
                      style={{ width: '80px', height: '110px', objectFit: 'cover', borderRadius: '8px' }}
                    />
                    <div>
                      <span className="cyber-badge mb-2">IN DEVELOPMENT</span>
                      <h6 className="fw-bold text-white mb-1">Roosevelt</h6>
                      <small className="text-muted d-block">Role: Theodore Roosevelt</small>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="row row-cols-2 row-cols-md-3 g-3">
                ...
                <div className="col">
                  <div className="movie-card h-100">
                    ...
                    <div className="p-3">
                      <h6 className="fw-bold text-white mb-1 text-truncate">Inception</h6>
                      <p className="small text-muted mb-0">Role: Dom Cobb</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col">
                  <div className="movie-card h-100">
                    <div className="card-img-wrapper">
                      <img src="https://m.media-amazon.com/images/M/MV5BY2IzNzNmNTItNDlhNy00YzJiLTg3ZDQtNDM1MzA1MzFiNWU1XkEyXkFqcGdeQXVyNjU0OTQ0OTY@._V1_.jpg" alt="Titanic" />
                    </div>
                    <div className="p-3">
                      <h6 className="fw-bold text-white mb-1 text-truncate">Titanic</h6>
                      <p className="small text-muted mb-0">Role: Jack Dawson</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col">
                  <div className="movie-card h-100">
                    <div className="card-img-wrapper">
                      <img src="https://m.media-amazon.com/images/M/MV5BY2FmODc3NjgtOTYxNi00OTgzLWFjNWYtN2JhYWJiNWYzE1ZkXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg" alt="The Revenant" />
                    </div>
                    <div className="p-3">
                      <h6 className="fw-bold text-white mb-1 text-truncate">The Revenant</h6>
                      <p className="small text-muted mb-0">Role: Hugh Glass</p>
                    </div>
                  </div>
                </div>
